...
def test_punctuation_handling():
    ...
    text = "What color is it? The theater, as we know it, is flavor."
    expected = "What colour is it? The theatre, as we know it, is flavour."
    assert convert_american_to_british_spelling(text) == expected
...
def test_multiple_sentences():
    ...
    text = "The theater was crowded! The colors were bright. Was it flavor?"
    expected = "The theatre was crowded! The colours were bright. Was it flavour?"
    assert convert_american_to_british_spelling(text) == expected
...
def test_valid_and_invalid_words():
    ...
    text = "The color of my xyzabc is flavor"
    expected = "The colour of my xyzabc is flavour"
    assert convert_american_to_british_spelling(text) == expected
